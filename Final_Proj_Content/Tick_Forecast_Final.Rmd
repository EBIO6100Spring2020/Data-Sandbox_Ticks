...
Yikes. They seem to correlate, but the model is consistently predicting a higher count than observed (bias).
...
For the plots in the "bad" dataset, plot the time series. Predictions are in blue, actuals are in red.
```{r}
...
What about the better predictions? Anything different?
```{r}
